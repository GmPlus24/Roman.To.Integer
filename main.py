...
import ui_resources
from roman_to_integer_ui import Ui_MainWindow
...
class RomanToInteger(QMainWindow, Ui_MainWindow):
    def __init__(self , appXX ):
        ...
        self.setupUi(self)
        self.setWindowIcon(QIcon(":/roman_to_integer_icon.png"))
        ...
        self.buttonBackspace.setIcon(QIcon(":/backspace_icon.png"))
        self.buttonBackspace.setIconSize(QSize(20,20))
        self.buttonCopyRoman.setIcon(QIcon(":/copy_icon.png"))
        self.buttonCopyInteger.setIcon(QIcon(":/copy_icon.png"))
        self.buttonAboutQt.setIcon(QIcon(":/qt_icon.png"))
        self.buttonAbout.setIcon(QIcon(":/information_icon.png"))
